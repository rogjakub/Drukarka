...
set_property PACKAGE_PIN U1 [get_ports {MTM}]
	set_property IOSTANDARD LVCMOS33 [get_ports {MTM}]
set_property PACKAGE_PIN T1 [get_ports {calib}]
	set_property IOSTANDARD LVCMOS33 [get_ports {calib}]
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {x_sup}]
	set_property IOSTANDARD LVCMOS33 [get_ports {x_sup}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {x_calib}]
	set_property IOSTANDARD LVCMOS33 [get_ports {x_calib}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {y_sup}]
	set_property IOSTANDARD LVCMOS33 [get_ports {y_sup}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {y_calib}]
	set_property IOSTANDARD LVCMOS33 [get_ports {y_calib}]
#Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {z_sup}]
	set_property IOSTANDARD LVCMOS33 [get_ports {z_sup}]
#Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {z_calib}]
	set_property IOSTANDARD LVCMOS33 [get_ports {z_calib}]
##Sch name = JC9
